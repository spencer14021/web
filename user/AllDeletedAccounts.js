...
class AllDeletedAccounts extends Component {
    state = {
        users: [],
        activePage: 1,
        totalPages: 0,
    ...
    componentDidMount() {
        this.getDeletedAccounts(this.state.activePage);
    }
    ...
    getDeletedAccounts = (pageNumber) => {
        axios.get(`/deleted_accounts?role=guest&page=${pageNumber}&pageSize=${itemsNumber}`).then(response => {
